...
uses
  ...
  WrapVclControls, Windows, Grids, TypInfo, Vcl.Outline, Vcl.ValEdit;
...
type
  ...
  TPyDelphiCustomOutline = class (TPyDelphiWinControl)
  private
    function  GetDelphiObject: TCustomOutline;
    procedure SetDelphiObject(const Value: TCustomOutline);
  public
    class function  DelphiObjectClass : TClass; override;
    // Properties
    property DelphiObject: TCustomOutline read GetDelphiObject write SetDelphiObject;
  end;

  TPyDelphiOutline = class (TPyDelphiWinControl)
  private
    function  GetDelphiObject: TOutline;
    procedure SetDelphiObject(const Value: TOutline);
  public
    class function  DelphiObjectClass : TClass; override;
    // Properties
    property DelphiObject: TOutline read GetDelphiObject write SetDelphiObject;
  end;
  ...
  TPyDelphiValueListEditor = class (TPyDelphiCustomDrawGrid)
  private
    function  GetDelphiObject: TValueListEditor;
    procedure SetDelphiObject(const Value: TValueListEditor);
  protected
    class function GetTypeName : string; override;
  public
    class function  DelphiObjectClass : TClass; override;
    ...
    // Properties
    property DelphiObject: TValueListEditor read GetDelphiObject write SetDelphiObject;
    function FindRow_Wrapper(args : PPyObject) : PPyObject; cdecl;
  end;
...
begin
  ...
  APyDelphiWrapper.DefineVar('doColumnTitles', 'doColumnTitles');
  APyDelphiWrapper.DefineVar('doAutoColResize', 'doAutoColResize');
  APyDelphiWrapper.DefineVar('doKeyColFixed', 'doKeyColFixed');
  APyDelphiWrapper.DefineVar('keyEdit', 'keyEdit');
  APyDelphiWrapper.DefineVar('keyAdd', 'keyAdd');
  APyDelphiWrapper.DefineVar('keyDelete', 'keyDelete');
  APyDelphiWrapper.DefineVar('keyUnique', 'keyUnique');

  APyDelphiWrapper.DefineVar('osText', 'osText');
  APyDelphiWrapper.DefineVar('osPlusMinusText', 'osPlusMinusText');
  APyDelphiWrapper.DefineVar('osPictureText', 'osPictureText');
  APyDelphiWrapper.DefineVar('osPlusMinusPictureText', 'osPlusMinusPictureText');
  APyDelphiWrapper.DefineVar('osTreeText', 'osTreeText');
  APyDelphiWrapper.DefineVar('osTreePictureText', 'osTreePictureText');
  APyDelphiWrapper.DefineVar('obPlus', 'obPlus');
  APyDelphiWrapper.DefineVar('obMinus', 'obMinus');
  APyDelphiWrapper.DefineVar('obOpen', 'obOpen');
  APyDelphiWrapper.DefineVar('obClose', 'obClose');
  APyDelphiWrapper.DefineVar('obLeaf', 'obLeaf');
  APyDelphiWrapper.DefineVar('otStandard', 'otStandard');
  APyDelphiWrapper.DefineVar('otOwnerDraw', 'otOwnerDraw');
  APyDelphiWrapper.DefineVar('ooDrawTreeRoot', 'ooDrawTreeRoot');
  APyDelphiWrapper.DefineVar('ooDrawFocusRect', 'ooDrawFocusRect');
  APyDelphiWrapper.DefineVar('ooStretchBitmaps', 'ooStretchBitmaps');

  APyDelphiWrapper.DefineVar('goFixedVertLine', 'goFixedVertLine');
  APyDelphiWrapper.DefineVar('goFixedHorzLine', 'goFixedHorzLine');
  APyDelphiWrapper.DefineVar('goVertLine', 'goVertLine');
  APyDelphiWrapper.DefineVar('goHorzLine', 'goHorzLine');
  APyDelphiWrapper.DefineVar('goRangeSelect', 'goRangeSelect');
  APyDelphiWrapper.DefineVar('goDrawFocusSelected', 'goDrawFocusSelected');
  APyDelphiWrapper.DefineVar('goRowSizing', 'goRowSizing');
  APyDelphiWrapper.DefineVar('goColSizing', 'goColSizing');
  APyDelphiWrapper.DefineVar('goRowMoving', 'goRowMoving');
  APyDelphiWrapper.DefineVar('goColMoving', 'goColMoving');
  APyDelphiWrapper.DefineVar('goEditing', 'goEditing');
  APyDelphiWrapper.DefineVar('goTabs', 'goTabs');
  APyDelphiWrapper.DefineVar('goRowSelect', 'goRowSelect');
  APyDelphiWrapper.DefineVar('goAlwaysShowEditor', 'goAlwaysShowEditor');
  APyDelphiWrapper.DefineVar('goThumbTracking', 'goThumbTracking');
  APyDelphiWrapper.DefineVar('goFixedColClick', 'goFixedColClick');
  APyDelphiWrapper.DefineVar('goFixedRowClick', 'goFixedRowClick');
  APyDelphiWrapper.DefineVar('goFixedHotTrack', 'goFixedHotTrack');
  APyDelphiWrapper.DefineVar('goFixedColDefAlign', 'goFixedColDefAlign');
  APyDelphiWrapper.DefineVar('goFixedRowDefAlign', 'goFixedRowDefAlign');

  APyDelphiWrapper.DefineVar('gdSelected', 'gdSelected');
  APyDelphiWrapper.DefineVar('gdFocused', 'gdFocused');
  APyDelphiWrapper.DefineVar('gdFixed', 'gdFixed');
  APyDelphiWrapper.DefineVar('gdRowSelected', 'gdRowSelected');
  APyDelphiWrapper.DefineVar('gdHotTrack', 'gdHotTrack');
  APyDelphiWrapper.DefineVar('gdPressed', 'gdPressed');

  APyDelphiWrapper.DefineVar('sdLeft', 'sdLeft');
  APyDelphiWrapper.DefineVar('sdRight', 'sdRight');
  APyDelphiWrapper.DefineVar('sdUp', 'sdUp');
  APyDelphiWrapper.DefineVar('sdDown', 'sdDown');
end;
...
begin
  ...
  APyDelphiWrapper.RegisterDelphiWrapper(TPyDelphiCustomOutline);
  APyDelphiWrapper.RegisterDelphiWrapper(TPyDelphiOutline);
  APyDelphiWrapper.RegisterDelphiWrapper(TPyDelphiCustomDrawGrid);
  APyDelphiWrapper.RegisterDelphiWrapper(TPyDelphiDrawGrid);
  APyDelphiWrapper.RegisterDelphiWrapper(TPyDelphiValueListEditor);
...
{ TPyDelphiCustomOutline }

class function TPyDelphiCustomOutline.DelphiObjectClass: TClass;
begin
  Result := TCustomOutline;
end;

function TPyDelphiCustomOutline.GetDelphiObject: TCustomOutline;
begin
  Result := TCustomOutline(inherited DelphiObject);
end;

procedure TPyDelphiCustomOutline.SetDelphiObject(const Value: TCustomOutline);
begin
  inherited DelphiObject := Value;
end;
...
class function TPyDelphiOutline.DelphiObjectClass: TClass;
begin
  Result := TOutline;
end;

function TPyDelphiOutline.GetDelphiObject: TOutline;
begin
  Result := TOutline(inherited DelphiObject);
end;

procedure TPyDelphiOutline.SetDelphiObject(const Value: TOutline);
begin
  inherited DelphiObject := Value;
end;
...
{ TPyDelphiValueListEditor }

class function TPyDelphiValueListEditor.DelphiObjectClass: TClass;
begin
  Result := TValueListEditor;
end;

class procedure TPyDelphiValueListEditor.RegisterMethods(
  PythonType: TPythonType);
begin
  PythonType.AddMethod('FindRow', @TPyDelphiValueListEditor.FindRow_Wrapper,
    PAnsiChar('TValueListEditor.FindRow()'#10 +
    'Used to search for the specified row.'));
end;

function TPyDelphiValueListEditor.GetDelphiObject: TValueListEditor;
begin
  Result := TValueListEditor(inherited DelphiObject);
end;

class function TPyDelphiValueListEditor.GetTypeName : string;
begin
  Result := 'ValueListEditor';
end;

procedure TPyDelphiValueListEditor.SetDelphiObject(const Value: TValueListEditor);
begin
  inherited DelphiObject := Value;
end;

function TPyDelphiValueListEditor.FindRow_Wrapper(args : PPyObject) : PPyObject;
var
  _key : PPyObject;
  _rowIndex : Integer;
  _varParam : TPyDelphiVarParameter;
begin
  ...
  Adjust(@Self);
  with GetPythonEngine do begin
    if PyArg_ParseTuple( args, 'O:FindRow', @_key) <> 0 then begin
      if DelphiObject.FindRow( PChar(PyObjectAsString(_key)), _rowIndex) then
        Result := PyLong_FromLong(_rowIndex)
      else
...
begin
  PythonType.AddMethod('GetCell', @TPyDelphiStringGrid.GetCell,
    PAnsiChar('TStringGrid.GetCell(col, row)'#10 +
    'Returns the content of a cell'));
  PythonType.AddMethod('SetCell', @TPyDelphiStringGrid.SetCell,
    PAnsiChar('TStringGrid.SetCell(col, row, value)'#10 +
...
initialization
  ...
  Classes.RegisterClasses([TDrawGrid, TStringGrid, TValueListEditor]);
end.
